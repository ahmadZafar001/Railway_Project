class CompartmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @compartment.save
        format.html { redirect_to compartments_url, notice: 'Compartment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @compartment.update(compartment_params)
        format.html { redirect_to compartments_url, notice: 'Compartment was successfully updated.' }
