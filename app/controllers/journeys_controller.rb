class JourneysController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @journey.save
        format.html { redirect_to journeys_url, notice: 'Journey was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @journey.update(journey_params)
        format.html { redirect_to journeys_url, notice: 'Journey was successfully updated.' }
  ...
  private
    ...
    def journey_params
      params.require(:journey).permit(:train_id, :route_id, :staff_id, :pass_count, :dep_time, :arr_time)
    end
end
