class FaresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fare.save
        format.html { redirect_to fares_url, notice: 'Fare was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @fare.update(fare_params)
        format.html { redirect_to fares_url, notice: 'Fare was successfully updated.' }
  ...
  private
    ...
    def fare_params
      params.require(:fare).permit(:train_compartment_id, :route_id, :amount)
    end
end
